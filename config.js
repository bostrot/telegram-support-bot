module.exports = {
    ...
    spam_time: 5 * 60 * 1000, // time (in MS) in which the user may send up to 5 messages to avoid spam DEFAULT: 5 Minutes
    ...
    lang_contactMessage: "Thank you for contacting us. We will answer as soon as possible.",
    lang_blockedSpam: "You sent quite a number of questions in the last while. Please calm down and wait until staff reviews them.",
    lang_ticket: "Ticket",
