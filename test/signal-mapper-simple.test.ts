...
describe('Signal Mapper', () => {
  describe('mapSignalMessageToContext', () => {
    it('should map basic Signal message to context', () => {
      const signalMsg: any = {
        envelope: {
          ...
          sourceUuid: null,
          sourceDevice: 1,
          serverReceivedTimestamp: 1640995200000,
          serverDeliveredTimestamp: 1640995200000,
        },
        dataMessage: {
    ...
    it('should handle source name with special characters', () => {
      ...
      // Username should be sanitized version - adjust expectation based on actual implementation
      expect(context.message.from.username).toContain('jose');
    });
    ...
    it('should handle missing dataMessage gracefully', () => {
      ...
      // This should throw an error as dataMessage is required
